...
double MEASloglikPG(double Cmeasure1,
    ...
    // people in sample
    double result=z1+z2+z3+z4+z5+z6+z7+0;
    result=exp(result);
    return(result);
}
...
vector<vector<long double> > F_likelihoodSCALAR(vector<double> par_likelihood,
    ...
    //0.1 Aalphas
    //0.1 Aalphas
    double aalpha1m=par_likelihood[0];
    double aalpha2m=par_likelihood[1];
    double aalpha3m=par_likelihood[2];
    double aalpha40m=par_likelihood[3];
    double aalpha41m=par_likelihood[4];
    double aalpha4m=0;

    
    //0.2 Skills
    double ttheta0=par_likelihood[5];
    double ttheta1=par_likelihood[6];
    double ttheta2=par_likelihood[7];
    double pphi=par_likelihood[8];
    double stdskills=par_likelihood[9];
    double ggammaf=par_likelihood[10];
    double ggammam=par_likelihood[11];
    ...
    double stdeffortmom=par_likelihood[17];
    double stdinvestment=par_likelihood[18];
    
    //0.5 Price of investment
    double priceINV0=par_likelihood[19];
    double priceINV1=par_likelihood[324];
    double priceINV=0;
    double MEASSkills=0;
    ...
    //0.1 Aalphas
    double aalpha1f=par_likelihood[25];
    double aalpha2f=par_likelihood[26];
    double aalpha3f=par_likelihood[27];
    double aalpha40f=par_likelihood[28];
    double aalpha41f=par_likelihood[29];
    double aalpha4f=0;
    ...
    double stdwf=par_likelihood[34];
    
    //0.4 Measurement system
    double stdeffortfat=par_likelihood[35];
    ...
    double stdmmu=par_likelihood[41]; //STD of barg shock
    ...
    //Mother
    double aalpha1m10=par_likelihood[47];
    double aalpha2m10=par_likelihood[48];
    double aalpha3m10=par_likelihood[49];
    double aalpha40m10=par_likelihood[50];
    double aalpha5m10=par_likelihood[51];
    double aalpha41m10=par_likelihood[52];
    double aalpha4m10=0;
    //Father
    double aalpha1f10=par_likelihood[53];
    double aalpha2f10=par_likelihood[54];
    double aalpha3f10=par_likelihood[55];
    double aalpha40f10=par_likelihood[56];
    double aalpha5f10=par_likelihood[57];
    double aalpha41f10=par_likelihood[58];
    double aalpha4f10=0;
    
    //Price of childcare
    double pchildcare0=par_likelihood[59];
    double pchildcare1=par_likelihood[60]; //Regarding the Distance
    
    //Preference shocks
    double MshockWA=par_likelihood[61];
    double MshockNWA=par_likelihood[62];
    double MshockWNA=par_likelihood[63];
    double MshockNWNA=par_likelihood[64];
    double FshockWA=par_likelihood[65];
    double FshockNWA=par_likelihood[66];
    double FshockWNA=par_likelihood[67];
    double FshockNWNA=par_likelihood[68];
    ...
    double aalpha3m10_mtjh=par_likelihood[73];
    
    //Mujer trabajadora y jefa de hogar 2012
    double aalpha3m12_mtjh=par_likelihood[74];
    
    //Age preferences for leisure
    double aalpha3mage10=par_likelihood[75];
    double aalpha3mage12=par_likelihood[76];
    ...
    double M_VS1_SBIRTH=par_likelihood[127];
    
    //2. CCONDPREGG3_2
    double M_A2_SBIRTH=par_likelihood[128];
    double M_VS2_SBIRTH=par_likelihood[129];
    
    
    //3. Ccondpregg3_3
    double M_A3_SBIRTH=par_likelihood[130];
    double M_VS3_SBIRTH=par_likelihood[131];
    
    
    //4. Ccondpregg3_4
    double M_A4_SBIRTH=par_likelihood[132];
    double M_VS4_SBIRTH=par_likelihood[133];
    
    
    //5. Ccondpregg3_5
    double M_A5_SBIRTH=par_likelihood[134];
    double M_VS5_SBIRTH=par_likelihood[135];
    
    
    //6. Ccondpregg3_6
    double M_A6_SBIRTH=par_likelihood[136];
    double M_VS6_SBIRTH=par_likelihood[137];
    
    
    //7. Ccondpregg3_7
    double M_A7_SBIRTH=par_likelihood[138];
    double M_VS7_SBIRTH=par_likelihood[139];
    
    
    //8. Ccondpregg3_8
    double M_A8_SBIRTH=par_likelihood[140];
    double M_VS8_SBIRTH=par_likelihood[141];
    
    
    //9. Ccondpregg3_9
    double M_A9_SBIRTH=par_likelihood[142];
    double M_VS9_SBIRTH=par_likelihood[143];
    
    
    //10. Ccondpregg4a_1
    double M_A10_SBIRTH=par_likelihood[144];
    double M_VS10_SBIRTH=par_likelihood[145];
    
    
    //11. Ccondpregg4a_2
    double M_A11_SBIRTH=par_likelihood[146];
    double M_VS11_SBIRTH=par_likelihood[147];
    
    
    //12. Ccondpregg4a_3
    double M_A12_SBIRTH=par_likelihood[148];
    double M_VS12_SBIRTH=par_likelihood[149];
    
    
    //13. Ccondpregg4a_4
    double M_A13_SBIRTH=par_likelihood[150];
    double M_VS13_SBIRTH=par_likelihood[151];
    
    
    //14. Ccondpregg4a_5
    double M_A14_SBIRTH=par_likelihood[152];
    double M_VS14_SBIRTH=par_likelihood[153];
    
    
    //15. Ccondpregg4a_6
    double M_A15_SBIRTH=par_likelihood[154];
    double M_VS15_SBIRTH=par_likelihood[155];
    
    
    //16. Ccondpregg4a_7
    double M_A16_SBIRTH=par_likelihood[156];
    double M_VS16_SBIRTH=par_likelihood[157];
    
    
    //17. Ccondpregg7b
    double M_A17_SBIRTH=par_likelihood[158];
    double M_VS17_SBIRTH=max(par_likelihood[159],0.001);
    
    
    //18. Ccondpregg8b
    double M_A18_SBIRTH=par_likelihood[160];
    double M_VS18_SBIRTH=max(par_likelihood[161],0.001);
    
    
    //19. Ccondpregg9
    double M_A19_SBIRTH=par_likelihood[162];
    double M_VS19_SBIRTH=max(par_likelihood[163],0.001);
    
    
    //20. Ccondpregg11b
    double M_A20_SBIRTH=par_likelihood[164];
    double M_VS20_SBIRTH=max(par_likelihood[165],0.001);
    
    
    //21. Ccondpregpreterm
    double M_A21_SBIRTH=par_likelihood[166];
    double M_VS21_SBIRTH=par_likelihood[167];
    
    //22. Ccondpregg24
    double M_A22_SBIRTH=par_likelihood[168];
    double M_VS22_SBIRTH=par_likelihood[169];
    
    //23. Ccondpregg23
    double M_A23_SBIRTH=par_likelihood[170];
    double M_VS23_SBIRTH=par_likelihood[171];
    
    //4. Skills of primary caregiver.
    //4.1 Cwais_pb_num
    double M_A1_SPG=par_likelihood[172];
    double M_V1_SPG=par_likelihood[173];
    //4.2 Cwais_pb_vo
    double M_A2_SPG=par_likelihood[174];
    double M_V2_SPG=par_likelihood[175];
    //4.3 Cbfi_pb_ama
    double M_A3_SPG=par_likelihood[176];
    double M_V3_SPG=par_likelihood[177];
    //4.4 Cbfi_pb_ape
    double M_A4_SPG=par_likelihood[178];
    double M_V4_SPG=par_likelihood[178];
    //4.5 Cbfi_pb_ext
    double M_A5_SPG=par_likelihood[180];
    double M_V5_SPG=par_likelihood[181];
    //4.6 Cbfi_pb_neu
    double M_A6_SPG=par_likelihood[182];
    double M_V6_SPG=par_likelihood[183];
    //4.7 Cbfi_pb_res
    double M_A7_SPG=par_likelihood[184];
    double M_V7_SPG=par_likelihood[185];
    //4.8 Cpsi_pb_total
    double M_A8_SPG=par_likelihood[186];
    double M_V8_SPG=par_likelihood[187];
    //------------------------------------------
    //5 BARGAINING POWER
    
    //5.1. Hbargg2a
    double M_A1_BARG=par_likelihood[188];
    double M_V1_BARG=par_likelihood[189];
    
    //5.2. Hbargg2b
    double M_A2_BARG=par_likelihood[190];
    double M_V2_BARG=par_likelihood[191];
    
    //5.3. Hbargg2c
    double M_A3_BARG=par_likelihood[192];
    double M_V3_BARG=par_likelihood[193];
    
    
    
    //5.4. Hbargg2d
    double M_A4_BARG=par_likelihood[194];
    double M_V4_BARG=par_likelihood[195];
    
    //5.5. Hbargg2e
    double M_A5_BARG=par_likelihood[196];
    double M_V5_BARG=par_likelihood[197];
    
    //5.6. Hbargg2f
    double M_A6_BARG=par_likelihood[198];
    double M_V6_BARG=par_likelihood[199];
    
    //5.7. Hbargg2g
    double M_A7_BARG=par_likelihood[200];
    double M_V7_BARG=par_likelihood[201];
    
    //5.8. Hbargg2h
    double M_A8_BARG=par_likelihood[202];
    double M_V8_BARG=par_likelihood[203];
    
    //5.9. Hbargg2i
    double M_A9_BARG=par_likelihood[204];
    double M_V9_BARG=par_likelihood[205];
    
    //5.10. Hbargg2j
    double M_A10_BARG=par_likelihood[206];
    double M_V10_BARG=par_likelihood[207];
    
    //5.11. Hwomdecide12
    double M_A11_BARG=par_likelihood[208];
    double M_V11_BARG=par_likelihood[209];
    
    //5.12. Hfathdecides12
    double M_A12_BARG=par_likelihood[210];
    double M_V12_BARG=par_likelihood[211];
    
    //5.13. Hbothdecide
    double M_A13_BARG=par_likelihood[212];
    double M_V13_BARG=par_likelihood[213];
    
    //5.14. Hcaresacwom
    double M_A14_BARG=par_likelihood[214];
    double M_V14_BARG=par_likelihood[215];
    
    //5.15. Hcaresacman
    double M_A15_BARG=par_likelihood[216];
    double M_V15_BARG=par_likelihood[217];
    
    //5.16. Hopofman121
    double M_A16_BARG=par_likelihood[218];
    double M_V16_BARG=par_likelihood[219];
    
    //5.17. Hopofman122
    double M_A17_BARG=par_likelihood[220];
    double M_V17_BARG=par_likelihood[221];
    
    //5.18. Hopofman123
    double M_A18_BARG=par_likelihood[222];
    double M_V18_BARG=par_likelihood[223];
    
    //5.19. Hopofman124
    double M_A19_BARG=par_likelihood[224];
    double M_V19_BARG=par_likelihood[225];
    
    
    //6. Investment in 2010 measures
    //6.1 Cinvh3
    double M_A1_INV10=par_likelihood[226];
    double M_V1_INV10=par_likelihood[227];
    //6.2 Cinvh4
    double M_A2_INV10=par_likelihood[228];
    double M_V2_INV10=par_likelihood[229];
    //6.3 Cinv5
    double M_A3_INV10=par_likelihood[230];
    double M_V3_INV10=par_likelihood[231];
    //6.4 Cinvh6
    double M_A4_INV10=par_likelihood[232];
    double M_V4_INV10=par_likelihood[233];
    //6.5 Cinvh7
    double M_A5_INV10=par_likelihood[234];
    double M_V5_INV10=par_likelihood[235];
    //6.6 Cinvh8
    double M_A6_INV10=par_likelihood[236];
    double M_V6_INV10=par_likelihood[237];
    //6.7 Cinvh9
    double M_A7_INV10=par_likelihood[238];
    double M_V7_INV10=par_likelihood[239];
    //6.8 Cinvh13
    double M_A8_INV10=par_likelihood[240];
    double M_V8_INV10=par_likelihood[241];
...
int it=0;
// [[Rcpp::export]]
long double F_likelihood_FIN(vector<double> PARDOUBLE){
    //0. Define the current directory
    it=it+1;
    cout << it<< " iteration number " << endl;
    chdir("/Users/rodrigoazuero/Dropbox/BACKUPRODRIGO/Research/Chile/RR/BEHAVIORAL71");
