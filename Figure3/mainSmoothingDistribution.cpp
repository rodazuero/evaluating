...
double MEASloglikSkills2010(double Cmeasure1,
    ...
    double result=z1+z2+z3+z4+z5+z6+z7+z8+z9+z10+z11;
    result=exp(result);
    return(result);
}
...
double MEASloglikSkills2012(double Cmeasure1,
    ...
    //4. Computing the final result
    double result=z1+z2+z3+z4+z5+z6+z7+z8+z9+z10+z11+z12+z13;
    result=exp(result);
    if(1==2){
...
double MEASloginv12(double Cmeasure1,
    ...
    double z9=max(abs((Cmeasure9-aalpha8*logINV)/Var9),1.0e-5);
...
long double F_likelihood(vector<double> par_likelihood,
    ...
    double M_VS1_S2010=max(exp(par_likelihood[79]),0.01);
    
    //1.2 CSTDtepsi_pb_len10
    double M_A2_S2010=par_likelihood[80];
    double M_VS2_S2010=max(exp(par_likelihood[81]),0.01);
    
    //1.3 CSTDtepsi_pb_mot10
    double M_A3_S2010=par_likelihood[82];
    double M_VS3_S2010=max(exp(par_likelihood[83]),0.01);
    
    
    //1.4 CSTDtvip_pb10
    double M_A4_S2010=par_likelihood[84];
    double M_VS4_S2010=max(exp(par_likelihood[85]),0.01);
    
    
    //1.5 CSTDcbcl1_pb_110
    double M_A5_S2010=par_likelihood[86];
    double M_VS5_S2010=max(exp(par_likelihood[87]),0.01);
    
    
    //1.6 CSTDcbcl1_pb_210
    double M_A6_S2010=par_likelihood[88];
    double M_VS6_S2010=max(exp(par_likelihood[89]),0.01);
    
    
    //1.7 CSTDcbcl1_pb_310
    double M_A7_S2010=par_likelihood[90];
    double M_VS7_S2010=max(exp(par_likelihood[91]),0.01);
    
    
    //1.8 CSTDcbcl1_pb_410
    double M_A8_S2010=par_likelihood[92];
    double M_VS8_S2010=max(exp(par_likelihood[93]),0.01);
    
    
    //1.9 CSTDcbcl1_pb_510
    double M_A9_S2010=par_likelihood[94];
    double M_VS9_S2010=max(exp(par_likelihood[95]),0.01);
    
    
    //1.10 CSTDcbcl1_pb_610
    double M_A10_S2010=par_likelihood[96];
    double M_VS10_S2010=max(exp(par_likelihood[97]),0.01);
    
    
    //1.11 CSTDcbcl1_pb_710
    double M_A11_S2010=par_likelihood[98];
    double M_VS11_S2010=max(exp(par_likelihood[99]),0.01);
    ...
    double M_VS1_S2012=max(exp(par_likelihood[101]),0.01);
    
    //1.2 CSTDtadi_pb_mot12
    double M_A2_S2012=par_likelihood[102];
    double M_VS2_S2012=max(exp(par_likelihood[103]),0.01);
    
    //1.3 CSTDtadi_pb_len12
    double M_A3_S2012=par_likelihood[104];
    double M_VS3_S2012=max(exp(par_likelihood[105]),0.01);
    
    //1.4 CSTDtadi_pb_se12
    double M_A4_S2012=par_likelihood[106];
    double M_VS4_S2012=max(exp(par_likelihood[107]),0.01);
    
    //1.5 CSTDbt_112
    double M_A5_S2012=par_likelihood[108];
    double M_VS5_S2012=max(exp(par_likelihood[109]),0.01);
    
    //1.6 CSTDbt_212
    double M_A6_S2012=par_likelihood[110];
    double M_VS6_S2012=max(exp(par_likelihood[111]),0.01);
    
    //1.7 CSTDbt_312
    double M_A7_S2012=par_likelihood[112];
    double M_VS7_S2012=max(exp(par_likelihood[113]),0.01);
    
    //1.8 CSTDbt_412
    double M_A8_S2012=par_likelihood[114];
    double M_VS8_S2012=max(exp(par_likelihood[115]),0.01);
    
    //1.9 CSTDbt_512
    double M_A9_S2012=par_likelihood[116];
    double M_VS9_S2012=max(exp(par_likelihood[117]),0.01);
    
    //1.10 CSTDbt_t12
    double M_A10_S2012=par_likelihood[118];
    double M_VS10_S2012=max(exp(par_likelihood[119]),0.01);
    
    //1.11 CSTDhtks_st12
    double M_A11_S2012=par_likelihood[120];
    double M_VS11_S2012=max(exp(par_likelihood[121]),0.01);
    
    
    //1.12 CSTDbdst_st12
    double M_A12_S2012=par_likelihood[122];
    double M_VS12_S2012=max(exp(par_likelihood[123]),0.01);
    
    //1.13 CSTDppvt_t12
    double M_A13_S2012=par_likelihood[124];
    double M_VS13_S2012=max(exp(par_likelihood[125]),0.01);
    ...
    double M_VS1_SBIRTH=max(exp(par_likelihood[127]),0.01);
    
    //2. CCONDPREGG3_2
    double M_A2_SBIRTH=par_likelihood[128];
    double M_VS2_SBIRTH=max(exp(par_likelihood[129]),0.01);
    
    
    //3. Ccondpregg3_3
    double M_A3_SBIRTH=par_likelihood[130];
    double M_VS3_SBIRTH=max(exp(par_likelihood[131]),0.01);
    
    
    //4. Ccondpregg3_4
    double M_A4_SBIRTH=par_likelihood[132];
    double M_VS4_SBIRTH=max(exp(par_likelihood[133]),0.01);
    
    
    //5. Ccondpregg3_5
    double M_A5_SBIRTH=par_likelihood[134];
    double M_VS5_SBIRTH=max(exp(par_likelihood[135]),0.01);
    
    
    //6. Ccondpregg3_6
    double M_A6_SBIRTH=par_likelihood[136];
    double M_VS6_SBIRTH=max(exp(par_likelihood[137]),0.01);
    
    
    //7. Ccondpregg3_7
    double M_A7_SBIRTH=par_likelihood[138];
    double M_VS7_SBIRTH=max(exp(par_likelihood[139]),0.01);
    
    
    //8. Ccondpregg3_8
    double M_A8_SBIRTH=par_likelihood[140];
    double M_VS8_SBIRTH=max(exp(par_likelihood[141]),0.01);
    
    
    //9. Ccondpregg3_9
    double M_A9_SBIRTH=par_likelihood[142];
    double M_VS9_SBIRTH=max(exp(par_likelihood[143]),0.01);
    
    
    //10. Ccondpregg4a_1
    double M_A10_SBIRTH=par_likelihood[144];
    double M_VS10_SBIRTH=max(exp(par_likelihood[145]),0.01);
    
    
    //11. Ccondpregg4a_2
    double M_A11_SBIRTH=par_likelihood[146];
    double M_VS11_SBIRTH=max(exp(par_likelihood[147]),0.01);
    
    
    //12. Ccondpregg4a_3
    double M_A12_SBIRTH=par_likelihood[148];
    double M_VS12_SBIRTH=max(exp(par_likelihood[149]),0.01);
    
    
    //13. Ccondpregg4a_4
    double M_A13_SBIRTH=par_likelihood[150];
    double M_VS13_SBIRTH=max(exp(par_likelihood[151]),0.01);
    
    
    //14. Ccondpregg4a_5
    double M_A14_SBIRTH=par_likelihood[152];
    double M_VS14_SBIRTH=max(exp(par_likelihood[153]),0.01);
    
    
    //15. Ccondpregg4a_6
    double M_A15_SBIRTH=par_likelihood[154];
    double M_VS15_SBIRTH=max(exp(par_likelihood[155]),0.01);
    
    
    //16. Ccondpregg4a_7
    double M_A16_SBIRTH=par_likelihood[156];
    double M_VS16_SBIRTH=max(exp(par_likelihood[157]),0.01);
    
    
    //17. Ccondpregg7b
    double M_A17_SBIRTH=par_likelihood[158];
    double M_VS17_SBIRTH=max(exp(par_likelihood[159]),0.01);
    
    
    //18. Ccondpregg8b
    double M_A18_SBIRTH=par_likelihood[160];
    double M_VS18_SBIRTH=max(exp(par_likelihood[161]),0.01);
    
    
    //19. Ccondpregg9
    double M_A19_SBIRTH=par_likelihood[162];
    double M_VS19_SBIRTH=max(exp(par_likelihood[163]),0.01);
    
    
    //20. Ccondpregg11b
    double M_A20_SBIRTH=par_likelihood[164];
    double M_VS20_SBIRTH=max(exp(par_likelihood[165]),0.01);
    
    
    //21. Ccondpregpreterm
    double M_A21_SBIRTH=par_likelihood[166];
    double M_VS21_SBIRTH=max(exp(par_likelihood[167]),0.01);
    
    //22. Ccondpregg24
    double M_A22_SBIRTH=par_likelihood[168];
    double M_VS22_SBIRTH=max(exp(par_likelihood[169]),0.01);
    
    //23. Ccondpregg23
    double M_A23_SBIRTH=par_likelihood[170];
    double M_VS23_SBIRTH=max(exp(par_likelihood[171]),0.01);
    
    //4. Skills of primary caregiver.
    //4.1 Cwais_pb_num
    double M_A1_SPG=par_likelihood[172];
    double M_V1_SPG=max(exp(par_likelihood[173]),0.01);
    //4.2 Cwais_pb_vo
    double M_A2_SPG=par_likelihood[174];
    double M_V2_SPG=max(exp(par_likelihood[175]),0.01);
    //4.3 Cbfi_pb_ama
    double M_A3_SPG=par_likelihood[176];
    double M_V3_SPG=max(exp(par_likelihood[177]),0.01);
    //4.4 Cbfi_pb_ape
    double M_A4_SPG=par_likelihood[178];
    double M_V4_SPG=max(exp(par_likelihood[178]),0.01);
    //4.5 Cbfi_pb_ext
    double M_A5_SPG=par_likelihood[180];
    double M_V5_SPG=max(exp(par_likelihood[181]),0.01);
    //4.6 Cbfi_pb_neu
    double M_A6_SPG=par_likelihood[182];
    double M_V6_SPG=max(exp(par_likelihood[183]),0.01);
    //4.7 Cbfi_pb_res
    double M_A7_SPG=par_likelihood[184];
    double M_V7_SPG=max(exp(par_likelihood[185]),0.01);
    //4.8 Cpsi_pb_total
    double M_A8_SPG=par_likelihood[186];
    double M_V8_SPG=max(exp(par_likelihood[187]),0.01);
    //------------------------------------------
    //5 BARGAINING POWER
    
    //5.1. Hbargg2a
    double M_A1_BARG=par_likelihood[188];
    double M_V1_BARG=max(exp(par_likelihood[189]),0.01);
    
    //5.2. Hbargg2b
    double M_A2_BARG=par_likelihood[190];
    double M_V2_BARG=max(exp(par_likelihood[191]),0.01);
    
    //5.3. Hbargg2c
    double M_A3_BARG=par_likelihood[192];
    double M_V3_BARG=max(exp(par_likelihood[193]),0.01);
    
    
    
    //5.4. Hbargg2d
    double M_A4_BARG=par_likelihood[194];
    double M_V4_BARG=max(exp(par_likelihood[195]),0.01);
    
    //5.5. Hbargg2e
    double M_A5_BARG=par_likelihood[196];
    double M_V5_BARG=max(exp(par_likelihood[197]),0.01);
    
    //5.6. Hbargg2f
    double M_A6_BARG=par_likelihood[198];
    double M_V6_BARG=max(exp(par_likelihood[199]),0.01);
    
    //5.7. Hbargg2g
    double M_A7_BARG=par_likelihood[200];
    double M_V7_BARG=max(exp(par_likelihood[201]),0.01);
    
    //5.8. Hbargg2h
    double M_A8_BARG=par_likelihood[202];
    double M_V8_BARG=max(exp(par_likelihood[203]),0.01);
    
    //5.9. Hbargg2i
    double M_A9_BARG=par_likelihood[204];
    double M_V9_BARG=max(exp(par_likelihood[205]),0.01);
    
    //5.10. Hbargg2j
    double M_A10_BARG=par_likelihood[206];
    double M_V10_BARG=max(exp(par_likelihood[207]),0.01);
    
    //5.11. Hwomdecide12
    double M_A11_BARG=par_likelihood[208];
    double M_V11_BARG=max(exp(par_likelihood[209]),0.01);
    
    //5.12. Hfathdecides12
    double M_A12_BARG=par_likelihood[210];
    double M_V12_BARG=max(exp(par_likelihood[211]),0.01);
    
    //5.13. Hbothdecide
    double M_A13_BARG=par_likelihood[212];
    double M_V13_BARG=max(exp(par_likelihood[213]),0.01);
    
    //5.14. Hcaresacwom
    double M_A14_BARG=par_likelihood[214];
    double M_V14_BARG=max(exp(par_likelihood[215]),0.01);
    
    //5.15. Hcaresacman
    double M_A15_BARG=par_likelihood[216];
    double M_V15_BARG=max(exp(par_likelihood[217]),0.01);
    
    //5.16. Hopofman121
    double M_A16_BARG=par_likelihood[218];
    double M_V16_BARG=max(exp(par_likelihood[219]),0.01);
    
    //5.17. Hopofman122
    double M_A17_BARG=par_likelihood[220];
    double M_V17_BARG=max(exp(par_likelihood[221]),0.01);
    
    //5.18. Hopofman123
    double M_A18_BARG=par_likelihood[222];
    double M_V18_BARG=max(exp(par_likelihood[223]),0.01);
    
    //5.19. Hopofman124
    double M_A19_BARG=par_likelihood[224];
    double M_V19_BARG=max(exp(par_likelihood[225]),0.01);
    
    
    //6. Investment in 2010 measures
    //6.1 Cinvh3
    double M_A1_INV10=par_likelihood[226];
    double M_V1_INV10=max(exp(par_likelihood[227]),0.01);
    //6.2 Cinvh4
    double M_A2_INV10=par_likelihood[228];
    double M_V2_INV10=max(exp(par_likelihood[229]),0.01);
    //6.3 Cinv5
    double M_A3_INV10=par_likelihood[230];
    double M_V3_INV10=max(exp(par_likelihood[231]),0.01);
    //6.4 Cinvh6
    double M_A4_INV10=par_likelihood[232];
    double M_V4_INV10=max(exp(par_likelihood[233]),0.01);
    //6.5 Cinvh7
    double M_A5_INV10=par_likelihood[234];
    double M_V5_INV10=max(exp(par_likelihood[235]),0.01);
    //6.6 Cinvh8
    double M_A6_INV10=par_likelihood[236];
    double M_V6_INV10=max(exp(par_likelihood[237]),0.01);
    //6.7 Cinvh9
    double M_A7_INV10=par_likelihood[238];
    double M_V7_INV10=max(exp(par_likelihood[239]),0.01);
    //6.8 Cinvh13
    double M_A8_INV10=par_likelihood[240];
    double M_V8_INV10=max(exp(par_likelihood[241]),0.01);
    ...
    double M_V1_INV12=max(exp(par_likelihood[243]),0.01);
    //7.2 Cinvf11b
    double M_A2_INV12=par_likelihood[244];
    double M_V2_INV12=max(exp(par_likelihood[245]),0.01);
    //7.3 Cinvf11c
    double M_A3_INV12=par_likelihood[246];
    double M_V3_INV12=max(exp(par_likelihood[247]),0.01);
    //7.4 Cinvf11d
    double M_A4_INV12=par_likelihood[248];
    double M_V4_INV12=max(exp(par_likelihood[249]),0.01);
    //7.5 Cinvf11e
    double M_A5_INV12=par_likelihood[250];
    double M_V5_INV12=max(exp(par_likelihood[251]),0.01);
    //7.6 Cinvf11f
    double M_A6_INV12=par_likelihood[252];
    double M_V6_INV12=max(exp(par_likelihood[253]),0.01);
    //7.7 Cinvf11g
    double M_A7_INV12=par_likelihood[254];
    double M_V7_INV12=max(exp(par_likelihood[255]),0.01);
    //7.8 Cinvf11h
    double M_A8_INV12=par_likelihood[256];
    double M_V8_INV12=max(exp(par_likelihood[257]),0.01);
    //7.9 Cinvf11i
    double M_A9_INV12=par_likelihood[258];
    double M_V9_INV12=max(exp(par_likelihood[259]),0.01);
    //7.10 Cinvf11j
    double M_A10_INV12=par_likelihood[260];
    double M_V10_INV12=max(exp(par_likelihood[261]),0.01);
    //7.11 Cinvf11k
    double M_A11_INV12=par_likelihood[262];
    double M_V11_INV12=max(exp(par_likelihood[263]),0.01);
    //7.12 Cinvhm2_10
    double M_A12_INV12=par_likelihood[264];
    double M_V12_INV12=max(exp(par_likelihood[265]),0.01);
    //7.13 Cinvhm2_11
    double M_A13_INV12=par_likelihood[266];
    double M_V13_INV12=max(exp(par_likelihood[267]),0.01);
    //7.14 Cinvhm2_12
    double M_A14_INV12=par_likelihood[268];
    double M_V14_INV12=max(exp(par_likelihood[269]),0.01);
    //7.15 Cinvhm2_13
    double M_A15_INV12=par_likelihood[270];
    double M_V15_INV12=max(exp(par_likelihood[271]),0.01);
    //7.16 Cinvhm2_14
    double M_A16_INV12=par_likelihood[272];
    double M_V16_INV12=max(exp(par_likelihood[273]),0.01);
    //7.17 Cinvhm2_15
    double M_A17_INV12=par_likelihood[274];
    double M_V17_INV12=max(exp(par_likelihood[275]),0.01);
    //7.18 Cinvhm2_16
    double M_A18_INV12=par_likelihood[276];
    double M_V18_INV12=max(exp(par_likelihood[277]),0.01);
    //7.19 Cinvhm2_18
    double M_A19_INV12=par_likelihood[278];
    double M_V19_INV12=max(exp(par_likelihood[279]),0.01);
    //7.20 Csharesbedroomhowmany12
    double M_A20_INV12=par_likelihood[280];
    double M_V20_INV12=max(exp(par_likelihood[281]),0.01);
    //7.21 Csharesbedhowmany12
    double M_A21_INV12=par_likelihood[282];
    double M_V21_INV12=max(exp(par_likelihood[283]),0.01);
    
    //8. PARENT's effort in 2010
    //8.1 g42_a
    double M_A1_EFF10=par_likelihood[284];
    double M_V1_EFF10=max(exp(par_likelihood[285]),0.01);
    //8.2 g42_b
    double M_A2_EFF10=par_likelihood[286];
    double M_V2_EFF10=max(exp(par_likelihood[287]),0.01);
    //8.3 g42_c
    double M_A3_EFF10=par_likelihood[288];
    double M_V3_EFF10=max(exp(par_likelihood[289]),0.01);
    //8.4 g42_d
    double M_A4_EFF10=par_likelihood[290];
    double M_V4_EFF10=max(exp(par_likelihood[291]),0.01);
    //8.5 g42_e
    double M_A5_EFF10=par_likelihood[292];
    double M_V5_EFF10=max(exp(par_likelihood[293]),0.01);
    //8.6 g42_f
    double M_A6_EFF10=par_likelihood[294];
    double M_V6_EFF10=max(exp(par_likelihood[295]),0.01);
    
    //10. Effort of parents in 2012
    //10.1 f21a_p_t
    double M_A1_EFF12=par_likelihood[296];
    double M_V1_EFF12=max(exp(par_likelihood[297]),0.01);
    //10.2 f21b_p_t
    double M_A2_EFF12=par_likelihood[298];
    double M_V2_EFF12=max(exp(par_likelihood[299]),0.01);
    //10.3 f21c_p_t
    double M_A3_EFF12=par_likelihood[300];
    double M_V3_EFF12=max(exp(par_likelihood[301]),0.01);
    //10.4 f21d_p_t
    double M_A4_EFF12=par_likelihood[302];
    double M_V4_EFF12=max(exp(par_likelihood[303]),0.01);
    //10.5 f21e_p_t
    double M_A5_EFF12=par_likelihood[304];
    double M_V5_EFF12=max(exp(par_likelihood[305]),0.01);
    //10.6 f21f_p_t
    double M_A6_EFF12=par_likelihood[306];
    double M_V6_EFF12=max(exp(par_likelihood[307]),0.01);
    //10.7 f21g_p_t
    double M_A7_EFF12=par_likelihood[308];
    double M_V7_EFF12=max(exp(par_likelihood[309]),0.01);
    //10.8 f21h_p_t
    double M_A8_EFF12=par_likelihood[310];
    double M_V8_EFF12=max(exp(par_likelihood[311]),0.01);
    //10.9 f21i_p_t
    double M_A9_EFF12=par_likelihood[312];
    double M_V9_EFF12=max(exp(par_likelihood[313]),0.01);
    //10.10 f21j_p_t
    double M_A10_EFF12=par_likelihood[314];
    double M_V10_EFF12=max(exp(par_likelihood[315]),0.01);
    //10.11 f21k_p_t
    double M_A11_EFF12=par_likelihood[316];
    double M_V11_EFF12=max(exp(par_likelihood[317]),0.01);
    //10.12 f21l_p_t
    double M_A12_EFF12=par_likelihood[318];
    double M_V12_EFF12=max(exp(par_likelihood[319]),0.01);
    //10.13 f21m_p_t
    double M_A13_EFF12=par_likelihood[320];
    double M_V13_EFF12=max(exp(par_likelihood[321]),0.01);
    //10.14 f21n_p_t
    double M_A14_EFF12=par_likelihood[322];
    double M_V14_EFF12=max(exp(par_likelihood[323]),0.01);
    ...
    for (int ii=0;ii<SIZE;ii=ii+1){
        ...
        //Skills in 2010
        SKMeasure1=CSTDtepsi_pb_coo10[ii];
        SKMeasure2=CSTDtepsi_pb_len10[ii];
        SKMeasure3=CSTDtepsi_pb_mot10[ii];
        SKMeasure4=CSTDtvip_pb10[ii];
        SKMeasure5=CSTDcbcl1_pb_110[ii];
        SKMeasure6=CSTDcbcl1_pb_210[ii];
        SKMeasure7=CSTDcbcl1_pb_310[ii];
        SKMeasure8=CSTDcbcl1_pb_410[ii];
        SKMeasure9=CSTDcbcl1_pb_510[ii];
        SKMeasure10=CSTDcbcl1_pb_610[ii];
        SKMeasure11=CSTDcbcl1_pb_710[ii];
        
        //Skills in 2012
        SK2012Measure1=CSTDtadi_pb_cog12[ii];
        SK2012Measure2=CSTDtadi_pb_mot12[ii];
        SK2012Measure3=CSTDtadi_pb_len12[ii];
        SK2012Measure4=CSTDtadi_pb_se12[ii];
        SK2012Measure5=CSTDbt_112[ii];
        SK2012Measure6=CSTDbt_212[ii];
        SK2012Measure7=CSTDbt_312[ii];
        SK2012Measure8=CSTDbt_412[ii];
        SK2012Measure9=CSTDbt_512[ii];
        SK2012Measure10=CSTDbt_t12[ii];
        SK2012Measure11=CSTDhtks_st12[ii];
        SK2012Measure12=CSTDbdst_st12[ii];
        SK2012Measure13=CSTDppvt_t12[ii];
        
        
        //Skills at birth
        SKBIRTHMEASURE1=Ccondpregg3_1[ii];
        SKBIRTHMEASURE2=Ccondpregg3_2[ii];
        SKBIRTHMEASURE3=Ccondpregg3_3[ii];
        SKBIRTHMEASURE4=Ccondpregg3_4[ii];
        SKBIRTHMEASURE5=Ccondpregg3_5[ii];
        SKBIRTHMEASURE6=Ccondpregg3_6[ii];
        SKBIRTHMEASURE7=Ccondpregg3_7[ii];
        SKBIRTHMEASURE8=Ccondpregg3_8[ii];
        SKBIRTHMEASURE9=Ccondpregg3_9[ii];
        SKBIRTHMEASURE10=Ccondpregg4a_1[ii];
        SKBIRTHMEASURE11=Ccondpregg4a_2[ii];
        SKBIRTHMEASURE12=Ccondpregg4a_3[ii];
        SKBIRTHMEASURE13=Ccondpregg4a_4[ii];
        SKBIRTHMEASURE14=Ccondpregg4a_5[ii];
        SKBIRTHMEASURE15=Ccondpregg4a_6[ii];
        SKBIRTHMEASURE16=Ccondpregg4a_7[ii];
        SKBIRTHMEASURE17=Ccondpregg7b[ii];
        SKBIRTHMEASURE18=Ccondpregg8b[ii];
        SKBIRTHMEASURE19=Ccondpregg9[ii];
        SKBIRTHMEASURE20=Ccondpregg11b[ii];
        SKBIRTHMEASURE21=Ccondpregpreterm[ii];
        SKBIRTHMEASURE22=Ccondpregg24[ii];
        SKBIRTHMEASURE23=Ccondpregg23[ii];
        
        //SKILLS OF PRIMARY CAREGIVER
        SKPG1=Cwais_pb_num[ii];
        SKPG2=Cwais_pb_vo[ii];
        SKPG3=Cbfi_pb_ama[ii];
        SKPG4=Cbfi_pb_ape[ii];
        SKPG5=Cbfi_pb_ext[ii];
        SKPG6=Cbfi_pb_neu[ii];
        SKPG7=Cbfi_pb_res[ii];
        SKPG8=Cpsi_pb_total[ii];
        ...
        MBARG9=Hbargg2i[ii];
        MBARG10=Hbargg2j[ii];
        MBARG11=Hwomdecide12[ii];
        MBARG12=Hfathdecides12[ii];
        MBARG13=Hbothdecide[ii];
        MBARG14=Hcaresacwom[ii];
        MBARG15=Hcaresacman[ii];
        MBARG16=Hopofman121[ii];
        MBARG17=Hopofman122[ii];
        MBARG18=Hopofman123[ii];
        MBARG19=Hopofman124[ii];
        ...
        //Investment in 2012
        MINV1_12=Cinvf11a[ii];
        MINV2_12=Cinvf11b[ii];
        MINV3_12=Cinvf11c[ii];
        MINV4_12=Cinvf11d[ii];
        MINV5_12=Cinvf11e[ii];
        MINV6_12=Cinvf11f[ii];
        MINV7_12=Cinvf11g[ii];
        MINV8_12=Cinvf11h[ii];
        MINV9_12=Cinvf11i[ii];
        MINV10_12=Cinvf11j[ii];
        MINV11_12=Cinvf11k[ii];
        MINV12_12=Cinvhm2_10[ii];
        MINV13_12=Cinvhm2_11[ii];
        MINV14_12=Cinvhm2_12[ii];
        MINV15_12=Cinvhm2_13[ii];
        MINV16_12=Cinvhm2_14[ii];
        MINV17_12=Cinvhm2_15[ii];
        MINV18_12=Cinvhm2_16[ii];
        MINV19_12=Cinvhm2_18[ii];
        MINV20_12=Csharesbedroomhowmany12[ii];
        MINV21_12=Csharesbedhowmany12[ii];
        ...
        FEFF1_12=f21a_p_t[ii];
        FEFF2_12=f21b_p_t[ii];
        FEFF3_12=f21c_p_t[ii];
        FEFF4_12=f21d_p_t[ii];
        FEFF5_12=f21e_p_t[ii];
        FEFF6_12=f21f_p_t[ii];
        FEFF7_12=f21g_p_t[ii];
        FEFF8_12=f21h_p_t[ii];
        FEFF9_12=f21i_p_t[ii];
        FEFF10_12=f21j_p_t[ii];
        FEFF11_12=f21k_p_t[ii];
        FEFF12_12=f21l_p_t[ii];
        FEFF13_12=f21m_p_t[ii];
        FEFF14_12=f21n_p_t[ii];
        
        //mother's effort in 2012
        MEFF1_12=f21a_p_t[ii];
        MEFF2_12=f21b_p_t[ii];
        MEFF3_12=f21c_p_t[ii];
        MEFF4_12=f21d_p_t[ii];
        MEFF5_12=f21e_p_t[ii];
        MEFF6_12=f21f_p_t[ii];
        MEFF7_12=f21g_p_t[ii];
        MEFF8_12=f21h_p_t[ii];
        MEFF9_12=f21i_p_t[ii];
        MEFF10_12=f21j_p_t[ii];
        MEFF11_12=f21k_p_t[ii];
        MEFF12_12=f21l_p_t[ii];
        MEFF13_12=f21m_p_t[ii];
        MEFF14_12=f21n_p_t[ii];
        ...
        while (rr<RR){
            ...
            if (Cliveswithfather10[ii]==0 & Cliveswithmother10[ii]==1){
                ...
                if (Mfraclabor10[ii]==1 && Cchildcare10[ii]==1){
                    ...
                    loglikeffm_rr10=MEASloglikEFFORT2010(MEFF1_10, M_A1_EFF10, M_V1_EFF10,
                                                         ...
                                                         MEFF5_10, M_A5_EFF10, M_V5_EFF10,
                                                         MEFF6_10, M_A6_EFF10, M_V6_EFF10,Meffort_factor10W);
                    //loglikeffm_rr10=F_loglikelihood_generic(Meffort10[ii],Meffort_factor10W,MEASMeffort);
                ...
                if (Mfraclabor10[ii]==0 && Cchildcare10[ii]==0){
                    ...
                    loglikeffm_rr=
                    //F_loglikelihood_generic(Meffort10[ii],Meffort_factor10NW,MEASMeffort);
                ...
                if (Mfraclabor10[ii]==0 && Cchildcare10[ii]==1){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort10[ii], Meffort_factor10NW,MEASMeffort);
                    //cout << " here28 "<< endl;
            ...
            if (Cliveswithfather10[ii]==1 & Cliveswithmother10[ii]==1){
                ...
                (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                 ...
                 S0Vector[rr],1,PGVector[rr],Hmemberstotal10[ii])*CSkills_factor10shock;
                if (1==2){
                    cout << CSkills_factor10shock << " shock t=1"<< endl;
                }
                if(1==2){
                    //Print investments levels of mother to verify
                    cout << " ---------------- " << endl;
                    
                    cout << CInvestmentMean10WWA_TOG << "  CInvestmentMean10WWA_TOG in t1" << endl;
                    cout << CInvestmentMean10WWNA_TOG << "  CInvestmentMean10WWNA_TOG in t1" << endl;
                    cout << CInvestmentMean10WNWA_TOG << "  CInvestmentMean10WNWA_TOG in t1" << endl;
                    cout << CInvestmentMean10WNWNA_TOG << "  CInvestmentMean10WNWNA_TOG in t1" << endl;
                    cout << CInvestmentMean10NWWA_TOG << "  CInvestmentMean10NWWA_TOG in t1" << endl;
                    cout << CInvestmentMean10NWWNA_TOG << "  CInvestmentMean10NWWNA_TOG in t1" << endl;
                    cout << CInvestmentMean10NWNWA_TOG << "  CInvestmentMean10NWNWA_TOG in t1" << endl;
                    cout << CInvestmentMean10NWNWNA_TOG << "  CInvestmentMean10NWNWNA_TOG in t1" << endl;
                    cout << " ---------------- " << endl;
                    
                    //Print effort levels of mother to verify
                    cout << " ---------------- " << endl;
                    cout << MeffortMean10WW_TOG << "MeffortMean10WW_TOG"<< endl;
                    cout << MeffortMean10WNW_TOG << "  MeffortMean10WNW_TOG in t1" << endl;
                    cout << MeffortMean10NWW_TOG << "  MeffortMean10NWW_TOG in t1" << endl;
                    cout << MeffortMean10NWNW_TOG << "  MeffortMean10NWNW_TOG in t1" << endl;
                    
                    cout << " ---------------- " << endl;
                    
                    //Print effort levels of father to verify
                    cout << " ---------------- " << endl;
                    cout << " ---------------- " << endl;
                    cout << FeffortMean10WW_TOG << "FeffortMean10WW_TOG"<< endl;
                    cout << FeffortMean10WNW_TOG << "  FeffortMean10WNW_TOG in t1" << endl;
                    cout << FeffortMean10NWW_TOG << "  FeffortMean10NWW_TOG in t1" << endl;
                    cout << FeffortMean10NWNW_TOG << "  FeffortMean10NWNW_TOG in t1" << endl;
                    
                    cout << " ---------------- " << endl;
                    cout << " ---------------- " << endl;
                    
                    
                    //Print skills to verify
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10shock << " shock t=1"<< endl;
                    cout << " -------- " << endl;
                    cout << CSkills_factor10WWA_TOG << "  CSkills_factor10WWA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10WW_TOG,
                    ...
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ...
                     MeffortMean10WW_TOG,
                     CInvestmentMean10WWNA_TOG,
                     S0Vector[rr],0,PGVector[rr],Hmemberstotal10[ii]);
                    ...
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10WNWA_TOG << "  CSkills_factor10WNWA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10WNW_TOG,
                     ...
                     CInvestmentMean10WNWA_TOG,
                     S0Vector[rr],1,PGVector[rr],Hmemberstotal10[ii]);
                    cout << MEASloglikSkills2010(SKMeasure1, M_A1_S2010,M_VS1_S2010,SKMeasure2, M_A2_S2010,M_VS2_S2010,SKMeasure3, M_A3_S2010,M_VS3_S2010,SKMeasure4, M_A4_S2010,M_VS4_S2010,SKMeasure5, M_A5_S2010,M_VS5_S2010,SKMeasure6, M_A6_S2010,M_VS6_S2010,SKMeasure7, M_A7_S2010,M_VS7_S2010,SKMeasure8, M_A8_S2010,M_VS8_S2010,SKMeasure9, M_A9_S2010,M_VS9_S2010,SKMeasure10, M_A10_S2010,M_VS10_S2010,SKMeasure11, M_A11_S2010,M_VS11_S2010,CSkills_factor10WNWA_TOG) << " likelihood of skills " << endl;
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10WNWNA_TOG << "  CSkills_factor10WNWNA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10WNW_TOG,
                    ...
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10NWWA_TOG << "  CSkills_factor10NWWA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10NWW_TOG,
                     ...
                     CInvestmentMean10NWWA_TOG,
                     S0Vector[rr],1,PGVector[rr],Hmemberstotal10[ii]);
                    cout << MEASloglikSkills2010(SKMeasure1, M_A1_S2010,M_VS1_S2010,SKMeasure2, M_A2_S2010,M_VS2_S2010,SKMeasure3, M_A3_S2010,M_VS3_S2010,SKMeasure4, M_A4_S2010,M_VS4_S2010,SKMeasure5, M_A5_S2010,M_VS5_S2010,SKMeasure6, M_A6_S2010,M_VS6_S2010,SKMeasure7, M_A7_S2010,M_VS7_S2010,SKMeasure8, M_A8_S2010,M_VS8_S2010,SKMeasure9, M_A9_S2010,M_VS9_S2010,SKMeasure10, M_A10_S2010,M_VS10_S2010,SKMeasure11, M_A11_S2010,M_VS11_S2010,CSkills_factor10NWWA_TOG) << " likelihood of skills " << endl;
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10NWWNA_TOG << "  CSkills_factor10NWWNA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10NWW_TOG,
                     ...
                     CInvestmentMean10NWWNA_TOG,
                     S0Vector[rr],0,PGVector[rr],Hmemberstotal10[ii]);
                    cout << MEASloglikSkills2010(SKMeasure1, M_A1_S2010,M_VS1_S2010,SKMeasure2, M_A2_S2010,M_VS2_S2010,SKMeasure3, M_A3_S2010,M_VS3_S2010,SKMeasure4, M_A4_S2010,M_VS4_S2010,SKMeasure5, M_A5_S2010,M_VS5_S2010,SKMeasure6, M_A6_S2010,M_VS6_S2010,SKMeasure7, M_A7_S2010,M_VS7_S2010,SKMeasure8, M_A8_S2010,M_VS8_S2010,SKMeasure9, M_A9_S2010,M_VS9_S2010,SKMeasure10, M_A10_S2010,M_VS10_S2010,SKMeasure11, M_A11_S2010,M_VS11_S2010,CSkills_factor10NWWNA_TOG) << " likelihood of skills " << endl;
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10NWNWA_TOG << "  CSkills_factor10NWNWA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10NWNW_TOG,
                    ...
                    cout << " ---------------- " << endl;
                    cout << CSkills_factor10NWNWNA_TOG << "  CSkills_factor10NWNWNA_TOG in t1" << endl;
                    F_predskills
                    (ddelta0,ddelta1,ddelta2,ddelta3,ddelta4,Cedad_meses10[ii],
                     ttheta0,ttheta1,ttheta2,pphi,
                     ggammaf,ggammam,FeffortMean10NWNW_TOG,
                ...
                if (Mfraclabor10[ii]==0 && Ffraclabor10[ii]==0 && Cchildcare10[ii]==0){
                    ...
                    //loglikeffm_rr10=F_loglikelihood_generic(Meffort10[ii], MeffortMean10NWNW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr10=F_loglikelihood_generic(Feffort10[ii],FeffortMean10NWNW_TOG,MEASFeffort);
                ...
                if (Mfraclabor10[ii]==0 && Ffraclabor10[ii]==1 && Cchildcare10[ii]==0){
                    ...
                    //loglikeffm_rr10=F_loglikelihood_generic(Meffort10[ii],MeffortMean10WNW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr10=F_loglikelihood_generic(Feffort10[ii],FeffortMean10WNW_TOG,MEASFeffort);
                ...
                if (Mfraclabor10[ii]==1 && Ffraclabor10[ii]==0 && Cchildcare10[ii]==0){
                    ...
                    //loglikeffm_rr10=F_loglikelihood_generic(Meffort10[ii], MeffortMean10NWW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr10=F_loglikelihood_generic(Feffort10[ii],FeffortMean10NWW_TOG,MEASFeffort);
                ...
                if (Mfraclabor10[ii]==1 && Ffraclabor10[ii]==1 && Cchildcare10[ii]==0){
                    ...
                    //loglikeffm_rr10=F_loglikelihood_generic(Meffort10[ii],MeffortMean10WW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr10=F_loglikelihood_generic(Feffort10[ii], FeffortMean10WW_TOG,MEASFeffort);
        ...
        boost::random::discrete_distribution<int> distskills1(w1_rr_vector);
        iterator=0;
        wsum1=0;
        for (int mm=0; mm<RR;mm=mm+1){
        ...
        while (rr<RR){
            ...
            if (Cliveswithfather12[ii]==0 & Cliveswithmother12[ii]==1){
                ...
                if (Mfraclabor12[ii]==1){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort12[ii],Meffort_factor12W,MEASMeffort);
                    loglikefff_rr=0;
                ...
                if (Mfraclabor12[ii]==0){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort12[ii],Meffort_factor12NW,MEASMeffort);
                    loglikefff_rr=0;
            ...
            if (Cliveswithfather12[ii]==1 & Cliveswithmother12[ii]==1){
                ...
                //Print the output:
                if(1==2){
                    cout << CSkills_factor12shock << " CSkills_factor12shock " << endl;
                    cout << "-----" << endl;
                    cout << CInvestmentMean12WW_TOG << " CInvestmentMean12WW_TOG " << endl;
                    cout << CInvestmentMean12WNW_TOG << " CInvestmentMean12WNW_TOG " << endl;
                    cout << CInvestmentMean12NWW_TOG << " CInvestmentMean12NWW_TOG " << endl;
                    cout << CInvestmentMean12NWNW_TOG << " CInvestmentMean12NWNW_TOG " << endl;
                    cout << "-----" << endl;
                    cout << CSkills_factor12WW_TOG << " CSkills_factor12WW_TOG  " << endl;
                    F_predskills(ddelta0,ddelta1,ddelta2,ddelta3_12,ddelta4,
                                 Cedad_meses12[ii],
                                 ttheta0,ttheta1,ttheta2,pphi,
                                 ggammaf,ggammam,FeffortMean12WW_TOG,
                                 MeffortMean12WW_TOG,
                                 ...
                                 S1Vector[rr],Cchildcare12[ii],
                                 PGVector[rr],Hmemberstotal12[ii]);
                    cout << CSkills_factor12WNW_TOG << " CSkills_factor12WNW_TOG  " << endl;
                    F_predskills(ddelta0,ddelta1,ddelta2,ddelta3_12,ddelta4,
                                 Cedad_meses12[ii],
                                 ttheta0,ttheta1,ttheta2,pphi,
                                 ggammaf,ggammam,FeffortMean12WNW_TOG,
                    ...
                    cout << CSkills_factor12NWW_TOG << " CSkills_factor12NWW_TOG  " << endl;
                    F_predskills(ddelta0,ddelta1,ddelta2,ddelta3_12,ddelta4,
                                 Cedad_meses12[ii],
                                 ttheta0,ttheta1,ttheta2,pphi,
                                 ggammaf,ggammam,FeffortMean12NWW_TOG,
                                 ...
                                 S1Vector[rr],Cchildcare12[ii],
                                 PGVector[rr],Hmemberstotal12[ii]);
                    cout << CSkills_factor12NWNW_TOG << " CSkills_factor12NWNW_TOG  " << endl;
                    F_predskills(ddelta0,ddelta1,ddelta2,ddelta3_12,ddelta4,
                                 Cedad_meses12[ii],
                                 ttheta0,ttheta1,ttheta2,pphi,
                                 ggammaf,ggammam,FeffortMean12NWNW_TOG,
                ...
                if (Mfraclabor12[ii]==0 & Ffraclabor12[ii]==0){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort12[ii],MeffortMean12NWNW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr=F_loglikelihood_generic(Feffort12[ii],FeffortMean12NWNW_TOG,MEASFeffort);
                ...
                if (Mfraclabor12[ii]==0 & Ffraclabor12[ii]==1){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort12[ii], MeffortMean12WNW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr=F_loglikelihood_generic(Feffort12[ii],FeffortMean12WNW_TOG,MEASFeffort);
                ...
                if (Mfraclabor12[ii]==1 & Ffraclabor12[ii]==0){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort12[ii],MeffortMean12NWW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr=F_loglikelihood_generic(Feffort12[ii],FeffortMean12NWW_TOG,MEASFeffort);
                ...
                if (Mfraclabor12[ii]==1 & Ffraclabor12[ii]==1){
                    ...
                    //loglikeffm_rr=F_loglikelihood_generic(Meffort12[ii],MeffortMean12WW_TOG,MEASMeffort);
                    ...
                    //loglikefff_rr=F_loglikelihood_generic(Feffort12[ii],FeffortMean12WW_TOG,MEASFeffort);
        ...
        boost::random::discrete_distribution<int> distskills2(w2_rr_vector);
        iterator=0;
        wsum2=0;
        for (int mm=0; mm<RR;mm=mm+1){
            ...
            wsum2+=w2_rr_vectorAUX[mm];
            
            //Re-adapting the skills in t=0 and t=1. This is done for the smoothing distribution
            S0Vectoraux[mm]=S0Vector[iterator];
        ...
        if (SMOOTHINGFILTER==1){
            ...
            for (int indexOUT=0; indexOUT<RR; indexOUT=indexOUT+1){
                S2MATRIX[ii][indexOUT]=S2Vector[indexOUT];
                W2MATRIX[ii][indexOUT]=VECWEIGHTSSMOOTH2[indexOUT];
                if(1==1){
                    cout <<  S2MATRIX[ii][indexOUT] << "  S2MATRIX[ii][indexOUT] " << endl;
                }
            }
            denomL1=0;
            denomL0=0;
            ...
            for(int indexOUT=0; indexOUT<RR; indexOUT=indexOUT+1){
                ...
                for( int Middle=0; Middle<RR; Middle=Middle+1){
                    for(int iNner=0; iNner<RR; iNner=iNner+1){
                        MEASSkills=F_predskills(ddelta0,ddelta1,ddelta2,ddelta3_12,ddelta4,
                                                ...
                                                Meffort12Final,
                                                Investment12Final,
                                                S1Vector[iNner],Cchildcare12[ii],
                                                PGVector[rr],Hmemberstotal12[ii]);
                    ...
                    MEASSkills=F_predskills(ddelta0,ddelta1,ddelta2,ddelta3_12,ddelta4,
                                            ...
                                            Meffort12Final,
                                            Investment12Final,
                                            S1Vector[indexOUT],Cchildcare12[ii],
                                            PGVector[rr],Hmemberstotal12[ii]);
                ...
                S1MATRIX[ii][indexOUT]=S1Vector[indexOUT];
                W1MATRIX[ii][indexOUT]=VECWEIGHTSSMOOTH1[indexOUT];
            ...
            for (int indexOUT=0; indexOUT<RR; indexOUT=indexOUT+1){ //Looping across ii particles
                ...
                S0MATRIX[ii][indexOUT]=S0Vector[indexOUT];
                W0MATRIX[ii][indexOUT]=VECWEIGHTSSMOOTH0[indexOUT];
...
long double F_likelihood_FIN(const double *PARDOUBLE){
    ...
    //chdir("/Users/rodrigoazuero/Documents/Research/Chile/RR/BEHAVIORAL60");
    
    int NVAR=206; //Number of variables in file
    int SIZEOBS=1035; //Number of observations in file
    
    //First step making the vector<double> from the const(double *par)
    vector<double> PAR;
    PAR.resize(324);
    
    for (int it=0; it<324; it=it+1){
        PAR[it]=PARDOUBLE[it];
         cout << PAR[it]<< " PArit " << endl;
    ...
    //=========================================
    std::ifstream theFile ("BEHAVIORALexcel1.csv");
...

{
    ...
    if (HOPSPACK!=1){
        ...
        //the number 325. I load the 325 parameters in PAR but PARDOUBLE should contain only 324.
        ...
        std::ifstream PARAMETERS ("PAROPTFOUNDPARALLEL4.csv");
        ...
        //Set optimize=1 if I want to perform the optimization
        
        if(optimize==1){
            
            nlopt_opt opt3;
            opt3 = nlopt_create(NLOPT_LN_SBPLX, 324); /* algorithm and dimensionality */
            nlopt_set_min_objective(opt3, FLIKMINIMIZED, NULL);
            nlopt_set_xtol_rel(opt3, 1.0e-4);
            //nlopt_set_maxtime(opt3,  10);
            double x3[324]={0};
            for(int it=0;it<324;it=it+1){
                x3[it]=PARDOUBLE[it];
            }
